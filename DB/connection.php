...
class Connection 
{
    ...
    public function getBdd()
    {
        if (!$this->db){
            ...
            //$this->db= new PDO('mysql:host=localhost;dbname=test','',''); // vào dự án thật thì cần viết thông tin username vs pass vào trong file env, chứ ko đc viết thẳng vào code thế này)
